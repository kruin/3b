...
- meldt pas KLAAR als Main werkelijk `app-v48.js`, `config-v48.js`,
  `styles.css?v=48` en versie 48 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v48.html` en
