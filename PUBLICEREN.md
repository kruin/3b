...
- meldt pas KLAAR als Main werkelijk `app-v91.js`, `config-v91.js`,
  `styles.css?v=91` en versie 91 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v91.html` en
