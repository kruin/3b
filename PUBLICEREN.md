...
- meldt pas KLAAR als de publieke site werkelijk `app-v14.js`,
  `config-v14.js` en versie 14 levert.

Controleer aanvullend `https://kruin.github.io/3b/controle-v14.html`.
