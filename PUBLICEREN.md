...
- meldt pas KLAAR als Main werkelijk `app-v77.js`, `config-v77.js`,
  `styles.css?v=77` en versie 77 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v77.html` en
