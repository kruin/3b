...
- meldt pas KLAAR als de publieke site werkelijk `app-v16.js`,
  `config-v16.js` en versie 16 levert.

Controleer aanvullend `https://kruin.github.io/3b/controle-v16.html`.
