...
- meldt pas KLAAR als de publieke site werkelijk `app-v31.js`,
  `config-v31.js`, `styles.css?v=31` en versie 31 levert.

Controleer aanvullend `https://kruin.github.io/3b/controle-v31.html`.
