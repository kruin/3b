...
- meldt pas KLAAR als Main werkelijk `app-v51.js`, `config-v51.js`,
  `styles.css?v=51` en versie 51 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v51.html` en
