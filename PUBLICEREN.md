...
- meldt pas KLAAR als de publieke site werkelijk `app-v22.js`,
  `config-v22.js` en versie 22 levert.

Controleer aanvullend `https://kruin.github.io/3b/controle-v22.html`.
