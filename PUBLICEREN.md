...
- meldt pas KLAAR als Main werkelijk `app-v62.js`, `config-v62.js`,
  `styles.css?v=62` en versie 62 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v62.html` en
