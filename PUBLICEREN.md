...
- meldt pas KLAAR als Main werkelijk `app-v58.js`, `config-v58.js`,
  `styles.css?v=58` en versie 58 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v58.html` en
