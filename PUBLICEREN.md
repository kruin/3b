...
- meldt pas KLAAR als Main werkelijk `app-v68.js`, `config-v68.js`,
  `styles.css?v=68` en versie 68 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v68.html` en
