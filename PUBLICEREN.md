...
- meldt pas KLAAR als Main werkelijk `app-v65.js`, `config-v65.js`,
  `styles.css?v=65` en versie 65 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v65.html` en
