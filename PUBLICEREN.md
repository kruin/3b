...
- meldt pas KLAAR als Main werkelijk `app-v75.js`, `config-v75.js`,
  `styles.css?v=75` en versie 75 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v75.html` en
