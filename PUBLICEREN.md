...
- meldt pas KLAAR als Main werkelijk `app-v74.js`, `config-v74.js`,
  `styles.css?v=74` en versie 74 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v74.html` en
