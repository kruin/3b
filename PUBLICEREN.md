...
- meldt pas KLAAR als Main werkelijk `app-v93.js`, `config-v93.js`,
  `styles.css?v=93` en versie 93 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v93.html` en
