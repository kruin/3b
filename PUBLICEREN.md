...
- meldt pas KLAAR als de publieke site werkelijk `app-v29.js`,
  `config-v29.js`, `styles.css?v=29` en versie 29 levert.

Controleer aanvullend `https://kruin.github.io/3b/controle-v29.html`.
