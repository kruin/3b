...
- meldt pas KLAAR als de publieke site werkelijk `app-v30.js`,
  `config-v30.js`, `styles.css?v=30` en versie 30 levert.

Controleer aanvullend `https://kruin.github.io/3b/controle-v30.html`.
