...
- meldt pas KLAAR als de publieke site werkelijk `app-v21.js`,
  `config-v21.js` en versie 21 levert.

Controleer aanvullend `https://kruin.github.io/3b/controle-v21.html`.
