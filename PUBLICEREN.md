...
- meldt pas KLAAR als de publieke site werkelijk `app-v15.js`,
  `config-v15.js` en versie 15 levert.

Controleer aanvullend `https://kruin.github.io/3b/controle-v15.html`.
