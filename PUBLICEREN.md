...
- meldt pas KLAAR als Main werkelijk `app-v76.js`, `config-v76.js`,
  `styles.css?v=76` en versie 76 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v76.html` en
