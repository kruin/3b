...
- meldt pas KLAAR als Main werkelijk `app-v71.js`, `config-v71.js`,
  `styles.css?v=71` en versie 71 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v71.html` en
