...
- meldt pas KLAAR als de publieke site werkelijk `app-v27.js`,
  `config-v27.js` en versie 27 levert.

Controleer aanvullend `https://kruin.github.io/3b/controle-v27.html`.
