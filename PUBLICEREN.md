...
- meldt pas KLAAR als Main werkelijk `app-v47.js`, `config-v47.js`,
  `styles.css?v=47` en versie 47 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v47.html` en
