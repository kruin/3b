...
- meldt pas KLAAR als Main werkelijk `app-v57.js`, `config-v57.js`,
  `styles.css?v=57` en versie 57 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v57.html` en
