...
- meldt pas KLAAR als de publieke site werkelijk `app-v20.js`,
  `config-v20.js` en versie 20 levert.

Controleer aanvullend `https://kruin.github.io/3b/controle-v20.html`.
