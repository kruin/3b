...
- meldt pas KLAAR als Main werkelijk `app-v107.js`, `config-v107.js`,
  `styles.css?v=107` en versie 107 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v107.html` en
