...
- meldt pas KLAAR als Main werkelijk `app-v55.js`, `config-v55.js`,
  `styles.css?v=55` en versie 55 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v55.html` en
