...
- meldt pas KLAAR als Main werkelijk `app-v99.js`, `config-v99.js`,
  `styles.css?v=99` en versie 99 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v99.html` en
