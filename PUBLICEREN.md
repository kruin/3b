...
- meldt pas KLAAR als Main werkelijk `app-v59.js`, `config-v59.js`,
  `styles.css?v=59` en versie 59 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v59.html` en
