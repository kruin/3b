...
- meldt pas KLAAR als Main werkelijk `app-v83.js`, `config-v83.js`,
  `styles.css?v=83` en versie 83 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v83.html` en
