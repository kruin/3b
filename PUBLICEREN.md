...
- meldt pas KLAAR als Main werkelijk `app-v72.js`, `config-v72.js`,
  `styles.css?v=72` en versie 72 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v72.html` en
