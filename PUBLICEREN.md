...
- meldt pas KLAAR als Main werkelijk `app-v78.js`, `config-v78.js`,
  `styles.css?v=78` en versie 78 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v78.html` en
