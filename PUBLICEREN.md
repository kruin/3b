...
- meldt pas KLAAR als Main werkelijk `app-v95.js`, `config-v95.js`,
  `styles.css?v=95` en versie 95 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v95.html` en
