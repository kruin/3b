...
- meldt pas KLAAR als Main werkelijk `app-v52.js`, `config-v52.js`,
  `styles.css?v=52` en versie 52 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v52.html` en
