...
- meldt pas KLAAR als Main werkelijk `app-v110.js`, `config-v110.js`,
  `styles.css?v=110` en versie 110 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v110.html` en
