...
- meldt pas KLAAR als Main werkelijk `app-v108.js`, `config-v108.js`,
  `styles.css?v=108` en versie 108 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v108.html` en
