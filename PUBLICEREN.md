...
- meldt pas KLAAR als de publieke site werkelijk `app-v18.js`,
  `config-v18.js` en versie 18 levert.

Controleer aanvullend `https://kruin.github.io/3b/controle-v18.html`.
