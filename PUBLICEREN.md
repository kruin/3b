...
- meldt pas KLAAR als Main werkelijk `app-v66.js`, `config-v66.js`,
  `styles.css?v=66` en versie 66 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v66.html` en
