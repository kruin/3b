...
- meldt pas KLAAR als de publieke site werkelijk `app-v23.js`,
  `config-v23.js` en versie 23 levert.

Controleer aanvullend `https://kruin.github.io/3b/controle-v23.html`.
