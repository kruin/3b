...
- meldt pas KLAAR als Main werkelijk `app-v73.js`, `config-v73.js`,
  `styles.css?v=73` en versie 73 levert én Doc bereikbaar is.
...
Controleer aanvullend `https://kruin.github.io/3b/controle-v73.html` en
